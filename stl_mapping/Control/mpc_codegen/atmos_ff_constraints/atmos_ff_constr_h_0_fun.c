...
#else
  #define CASADI_PREFIX(ID) atmos_ff_constr_h_0_fun_ ## ID
#endif
...
/* atmos_ff_constr_h_0_fun:(i0[13],i1[6],i2[0],i3[25])->(o0[6]) */
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  casadi_int i, j, k;
  casadi_real **res1=res+1, *rr, *ss, *tt;
  const casadi_real **arg1=arg+4, *cs;
  casadi_real *w0=w+24, *w1=w+30, *w2=w+33, *w3=w+37, *w4=w+40, *w5=w+43, *w6=w+56, *w7=w+104, *w8=w+152, *w9=w+230, *w10=w+266, *w11=w+279, *w12=w+292, *w13=w+370, *w14=w+376, *w15=w+383;
  /* #0: @0 = zeros(6x1) */
  casadi_clear(w0, 6);
  /* #1: @1 = input[0][0] */
...
CASADI_SYMBOL_EXPORT int atmos_ff_constr_h_0_fun(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem){
  return casadi_f0(arg, res, iw, w, mem);
}

CASADI_SYMBOL_EXPORT int atmos_ff_constr_h_0_fun_alloc_mem(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT int atmos_ff_constr_h_0_fun_init_mem(int mem) {
  return 0;
}

CASADI_SYMBOL_EXPORT void atmos_ff_constr_h_0_fun_free_mem(int mem) {
}

CASADI_SYMBOL_EXPORT int atmos_ff_constr_h_0_fun_checkout(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT void atmos_ff_constr_h_0_fun_release(int mem) {
}

CASADI_SYMBOL_EXPORT void atmos_ff_constr_h_0_fun_incref(void) {
}

CASADI_SYMBOL_EXPORT void atmos_ff_constr_h_0_fun_decref(void) {
}

CASADI_SYMBOL_EXPORT casadi_int atmos_ff_constr_h_0_fun_n_in(void) { return 4;}

CASADI_SYMBOL_EXPORT casadi_int atmos_ff_constr_h_0_fun_n_out(void) { return 1;}

CASADI_SYMBOL_EXPORT casadi_real atmos_ff_constr_h_0_fun_default_in(casadi_int i) {
  switch (i) {
    default: return 0;
  }
}

CASADI_SYMBOL_EXPORT const char* atmos_ff_constr_h_0_fun_name_in(casadi_int i) {
  switch (i) {
    case 0: return "i0";
    case 1: return "i1";
    case 2: return "i2";
...
CASADI_SYMBOL_EXPORT const char* atmos_ff_constr_h_0_fun_name_out(casadi_int i) {
  switch (i) {
    case 0: return "o0";
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT const casadi_int* atmos_ff_constr_h_0_fun_sparsity_in(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT const casadi_int* atmos_ff_constr_h_0_fun_sparsity_out(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT int atmos_ff_constr_h_0_fun_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 8;
  if (sz_res) *sz_res = 3;
  if (sz_iw) *sz_iw = 14;
  if (sz_w) *sz_w = 389;
...
CASADI_SYMBOL_EXPORT int atmos_ff_constr_h_0_fun_work_bytes(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 8*sizeof(const casadi_real*);
  if (sz_res) *sz_res = 3*sizeof(casadi_real*);
  if (sz_iw) *sz_iw = 14*sizeof(casadi_int);
  if (sz_w) *sz_w = 389*sizeof(casadi_real);
  return 0;
}
