...
def generate_launch_description():
    ...
    ld.add_action(Node(
            ...
            executable='rviz2',
            name='rviz2',
            arguments=['-d', [os.path.join(get_package_share_directory('space_validation'), 'config.rviz')]]
    ))
...
#             name='plotjuggler',
#             arguments=['-l', os.path.join(get_package_share_directory('space_validation'), 'juggler_sitl_3.xml')]
#     ))
