...
def plot_results(sol):
    ...
    axs[2,0].set_ylabel('x_dot [m/s]')
    axs[2,1].set_ylabel('y_dot [m/s]')
    axs[2,2].set_ylabel('z_dot [m/s]')
...
plot_results(sol)
# plot_trajectory(sol, 50, True, "space_validation/Planning/figures/3d.gif", 10)
plt.show()
